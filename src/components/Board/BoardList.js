      ...
      <div className='container max-w-3xl px-4 mx-auto sm:px-8'>
        <div className='py-8'>
          <div className='flex flex-row justify-between w-full mb-1 sm:mb-0 items-center'>
            ...
            <Link
              to='/new'
              className='flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-blue-500 rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-blue-200'
              type='submit'>
              글쓰기
            </Link>
          </div>
